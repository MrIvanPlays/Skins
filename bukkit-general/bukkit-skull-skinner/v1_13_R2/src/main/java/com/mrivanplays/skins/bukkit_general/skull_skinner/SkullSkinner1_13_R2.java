...
public class SkullSkinner1_13_R2 implements SkullSkinner {
  ...
  public SkullOwner getSkullOwner(ItemStack item) {
    ...
    SkullMeta meta = (SkullMeta) item.getItemMeta();
    String ownerName =
        meta.getCustomTagContainer().getCustomTag(SKULL_OWNER_NAME_KEY, ItemTagType.STRING);
    String ownerUUIDString =
        meta.getCustomTagContainer().getCustomTag(SKULL_OWNER_UUID_KEY, ItemTagType.STRING);
