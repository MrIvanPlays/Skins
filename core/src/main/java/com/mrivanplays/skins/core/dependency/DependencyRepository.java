 ...
 *
 * <p>Original code: lucko/LuckPerms
 *
 * @author lucko
 */
public enum DependencyRepository {
  ...
  /**
   * Downloads the raw bytes of the {@code dependency}, and ensures the downloaded bytes match the
   * checksum.
   *
   * @param dependency the dependency to download
   * @return the downloaded bytes
  ...
  /**
   * Downloads the the {@code dependency} to the {@code file}, ensuring the downloaded bytes match
   * the checksum.
   *
   * @param dependency the dependency to download
