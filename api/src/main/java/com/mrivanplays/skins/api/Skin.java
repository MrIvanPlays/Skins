...
public final class Skin {
  ...
  /**
   * Returns the owner of this skin by data from the specified {@link DataProvider} in the {@link
   * SkinsApi}
   *
   * @return owner
   */
   ...
   * {@link #getOwner()} by data from the specified {@link DataProvider} in the {@link SkinsApi}
   *
   * @return texture
   */
  @NotNull
